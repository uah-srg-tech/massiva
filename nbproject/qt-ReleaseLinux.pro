...
QMAKE_CC = gcc
QMAKE_CXX = g++
DEFINES += LIBXML_STATIC NOT_MK2_DEV NOT_PCI_DEV NOT_USB_DEV PLOTS 
INCLUDEPATH += /usr/include/libxml2 /usr/local/qwt-6.1.3/include 
LIBS += -lxml2 -lpthread -lm -Wl,-rpath,/usr/local/qwt-6.1.3/lib /usr/local/qwt-6.1.3/lib/libqwt.so  
