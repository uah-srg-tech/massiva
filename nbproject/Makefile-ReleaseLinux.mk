...
LDLIBSOPTIONS=-lxml2 -lpthread -lm /usr/local/qwt-6.1.3/lib/libqwt.so
...
.build-conf: ${BUILD_SUBPROJECTS} nbproject/qt-${CND_CONF}.mk
	"${MAKE}" -f nbproject/qt-${CND_CONF}.mk ${CND_CONF}/massiva

${CND_BUILDDIR}/ReleaseLinux/%.o: nbproject/qt-${CND_CONF}.mk
